...
class LeaveMessageService extends Service {
  async addTypeA(params) {
    ...
    try {
      const result = await app.mysql.insert('leave_message', { ...params, ...data });
      return result;
    } catch (error) {
      console.log(error);
      return null;
  ...
  async delete(id) {
    ...
    const { app } = this;
    try {
      const result = await app.mysql.delete('leave_message', id);
      return result;
    } catch (error) {
      console.log(error);
      return null;
  ...
  async query(params) {
    ...
    const { app } = this;
    try {
      const result = await app.mysql.select('leave_message', { where: params });
      result.forEach(item => {
  ...
  async blogQuery(params) {
    ...
    const { app } = this;
    try {
      const resultA = await app.mysql.select('leave_message', { where: params });
      console.log(resultA);
      const resultB = await app.mysql.select('leave_message', { where: paramsB });
      console.log(resultB);
...
module.exports = LeaveMessageService;
